...
import { DataList } from '@/app/users/[id]/(update)/qualifications/components/data-list';
import { UserQualificationsForm } from '@/app/users/[id]/(update)/qualifications/form';
